...
// .............................................................
    ...
    Block::make('Team Section Content')
        ->add_fields(array(

            Field::make('text', 'team_section_title', 'Section Title')
                ->set_default_value('Meet Our Team of Experts'),

            Field::make('textarea', 'team_section_description', 'Section Description'),

            // Search placeholder
            Field::make('text', 'team_search_placeholder', 'Search Placeholder')
                ->set_default_value('Search here...'),

            // Select placeholder
            Field::make('text', 'team_select_placeholder', 'Select Placeholder')
                ->set_default_value('Select option'),

            // Button
            Field::make('text', 'team_button_text', 'Button Text'),
            Field::make('text', 'team_button_link', 'Button Link'),

            // Team Members (complex field)
            Field::make('complex', 'team_members', 'Team Members')
                ...
                ->add_fields(array(
                    ...
                    // Field::make('image', 'team_button_img', 'Button image'), 
                    Field::make('text', 'team_button_link', 'Button Link'),
                    Field::make('text', 'category', 'Category'),
                )),
        ))
        ->set_render_callback(function ($fields, $attributes, $inner_blocks) {
            // Include your template file here
            include get_template_directory() . '/components/our-people/our-people.php';
        });
