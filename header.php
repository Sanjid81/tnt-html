        ...
        <div class="nav-wraper">
            <div class="nav-first-half">
                ...
                <a href="<?php echo esc_url(home_url('/')); ?>" class="logo">
                    ...
                    if ($nav_logo_id):
                        ...
                        ?>
                        <img src="<?php echo esc_url(IMG . '/logo.svg'); ?>" alt="<?php bloginfo('name'); ?>" class="h-10">
                    <?php endif; ?>
                </a>
            ...
            <div class="nav-sec-half">
                <?php if ($btn_text = carbon_get_theme_option('button_text')): ?>
                    <a href="<?php echo esc_url(carbon_get_theme_option('button_link')); ?>" class="primary-button">
