                 ...
                 <div class="specs-items-wrapper">
                               <div class="spec-item">
                                <div class="spec-value">
                                       <div class="spec-label">Up to</div>

                                    <?php echo esc_html( $fields['pressure_value'] ); ?>
                                    <span class="spec-unit">
                                        <?php echo esc_html( $fields['pressure_unit'] ); ?>
                                    </span>
                                </div>
                                <div class="spec-label" style="margin-top: 8px;">Pressure</div>
                            </div>
                            ...
                            <div class="spec-item">
                                ...
                                <div class="spec-label" style="margin-top: 8px;">Flow</div>
                            </div>
                        ...
                        <?php if ( ! empty( $fields['button_text'] ) ) : ?>
                            <a
                                href="<?php echo esc_url( $fields['button_link'] ); ?>"
